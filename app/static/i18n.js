(() => {
  const messages = {
    zh: {
      ...
      "form.processing1": "🐌 小蜗牛正在读懂你的心事……",
      "form.processing2": "🕯️ 它正在为这封信写下未来的地址……",
      "form.processing3": "🌿 正在确认这封信可以安心出发……",
      "form.progress1": "正在理解这封信",
      "form.progress2": "正在整理未来的地址",
      "form.progress3": "正在确认可以寄出",
      "form.progressStep": "第 {current} 步 / 3",
      "form.progressSuccess": "✓ 已成功寄出，慢递蜗牛已经收到了",
      "form.progressClarification": "还差一点信息，信暂时没有寄出",
      "form.progressFailed": "这次没有寄出",
      "form.clarificationIntro": "在寄出前，小蜗牛还想确认一件事：",
      "form.failed": "这封信暂时没有寄出去，请稍后再试",
      "form.successPublic": "✓ 已经成功寄出，慢递蜗牛已经收到了这封信。",
      "form.journey": "看看它的旅程",
      "form.successPrivate":
    ...
    en: {
      ...
      "form.processing1": "🐌 The little mail snail is reading your worry…",
      "form.processing2": "🕯️ It is writing the future address for your letter…",
      "form.processing3": "🌿 It is making sure your letter is ready to leave…",
      "form.progress1": "Reading your letter",
      "form.progress2": "Writing its future address",
      "form.progress3": "Making sure it can leave",
      "form.progressStep": "Step {current} of 3",
      "form.progressSuccess": "✓ Sent successfully — the mail snail has it",
      "form.progressClarification": "One small detail is needed before it can leave",
      "form.progressFailed": "This letter did not leave this time",
      "form.clarificationIntro": "Before it leaves, the little snail wants to ask:",
      "form.failed":
        "This letter could not leave just yet. Please try again soon.",
      "form.successPublic": "✓ Sent successfully — the mail snail has your letter.",
